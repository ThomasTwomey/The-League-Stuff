...
public class SlotMachine implements ActionListener
{
	...
	public SlotMachine()
	{
		...
		slot2 = new JLabel("1");
		slot3 = new JLabel("1");
		result = new JLabel("Press Roll to Start");
		total = new JLabel("Total: " + totalBet);
		...
		result.setBounds(40, 150, 225, 50);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (e.getSource() == roll)
		{
							...
							.parseInt(slot3.getText()))
			{
				...
				{
					totalBet = totalBet
							+ ((Integer.parseInt(bet.getText())) * 2);
					total.setText("Total: " + totalBet);
				}
				result.setText("Win!");
			} else
			{
