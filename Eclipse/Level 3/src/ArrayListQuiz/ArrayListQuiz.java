...
public class ArrayListQuiz extends TestCase {
	...
	public void testListIteration() throws Exception {
		...
		testList.add("natch");
		testList.add("bounce");
		assertEquals("radnatchbounce",
				LearningArrayLists.iterateOver(testList));
	}
	...
	public void testAddStuff() throws Exception {
		...
		testList.add(new Integer(6));
		testList.add(new Integer(6));
		assertEquals(18, LearningArrayLists.addAllInteger(testList));
	}

	public void testConcatenateStrings() throws Exception {
		ArrayList<String> testList = LearningArrayLists
				.createStringTypedArrayList();
		testList.add("6");
		testList.add("6");
		testList.add("6");
